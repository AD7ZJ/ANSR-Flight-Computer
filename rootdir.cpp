...
int FAT16::openroot(void)
{
    ...
    if(!partition)
    {
        ...
        if(!partition)
        {
            uart->WriteLine("opening partition failed\n\r");
            return 1;
        }
    }
    ...
    if(!fs)
    {
    	uart->WriteLine("opening filesystem failed\n\r");
        return 1;
    }
    ...
    if(!dd)
    {
    	uart->WriteLine("opening root directory failed\n\r");
        return 1;
    }
    return 0;
}
